			...
			<div class="col-md-4 text-center">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<p>
							<?= $translate->element("view", "home_cat1_text1_free_vip"); ?>
						</p>
					</div>
					<div class="panel-footer">
						<a href="https://epicaim.net/dl/EpicAimFree.exe" target="_blank" class="btn btn-default btn-block">Download cheat client</a>
					</div>
				</div>
			</div>
			<div class="col-md-4 text-center">
				...
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<p>
							...
							<?= $translate->element("view", "home_cat2_text_vip"); ?><b style='color:green;'> <?= $translate->element("view", "home_cat2_text_free_vip"); ?> !</b><br/>
							<br/>
