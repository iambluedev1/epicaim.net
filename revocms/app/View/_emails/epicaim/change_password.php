                                                ...
                                                <td  class="w580"  width="580">
                                                    <table class="w580"  width="580" cellpadding="0" cellspacing="0" border="0">
                                                        <tbody>                                                            
                                                            <tr>
                                                                <td class="w580"  width="580">
                                                                    <h2 style="color:#ba2323; font-size:22px; padding-top:12px;"><?= $translate->element("change_password", "title"); ?></h2>
                                                                    ...
                                                                    <div align="left" class="article-content" style="color: white;">
                                                                        ...
                                                                        <p>
                                                                            <?= $translate->element("change_password", "line_1"); ?>
                                                                        </p>
                                                                        <p>
                                                                            <?= $translate->element("change_password", "line_2"); ?>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
